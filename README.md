Este é um projeto simples onde os usuários podem inserir nomes em uma lista, e a aplicação realizará um sorteio aleatório para determinar o "amigo secreto".
